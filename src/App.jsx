...
function App() {
  ...
  const handlePageChange = (newPage) => {
    const pages = ["create", "invoices", "items", "companies"];
  ...
  const renderPage = () => {
    switch (activePage) {
      case "create":
        return !invoiceData ? (
          <InvoiceForm
            key={
              editingInvoiceData
                ? `edit-${editingInvoiceData.invoiceNumber}`
                : "new-invoice"
            }
          ...
          <InvoicePreview
            ...
            onEdit={
              viewingFromList ? () => handleEditInvoice(invoiceData) : undefined
            }
      ...
      case "invoices":
        return (
          <InvoiceList
            onViewInvoice={handleViewFromList}
